...
$shutter_island = new Movie("Shutter Island", "Martin Scorsese", 4, new Genre("Thriller psicologico"));
$inception = new Movie("Inception", "Christopher Nolan", 5, new Genre("Thriller psicologico"));
